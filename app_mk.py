...
2. 각 보기는 반드시 번호(①~⑤)마다 줄바꿈(Enter 2번)을 해서 한 줄에 하나씩 분리해 작성할 것.
3. ⑤번 보기가 끝난 직후 추가 번호 나열(예: ① ② ③ ④ ⑤)이나 불필요한 기호를 절대 덧붙이지 말 것.
4. 학생이 답을 선택하기 전에는 절대 정답이나 해설을 먼저 알려주지 말 것.
5. 첫 문제와 후속 문제는 모두 PDF 전 범위에서 무작위(랜덤)로 출제할 것.
